...
public class Assessment13Day extends Activity implements OnCheckedChangeListener{
	...
	next.setOnClickListener(new OnClickListener() {
		...
		// create a new intent and pass to day 2
			...
			if(responseID==-1)
			{
				...
				Intent next2=new Intent(Assessment13Day.this,Assessment14Night.class);
			...
			Intent nextScreen=new Intent(Assessment13Day.this,Assessment14Night.class);
	...
	public void onCheckedChanged(RadioGroup group, int checkedId) {
		...
		case R.id.DayRadioButton:
			...
			values.put(dbOpenHelper.COLUMN_RESPONSE_THIRTEEN, 0);
			int rows=Main.datasource.updateRecord(values,(int)Main.rowid);
			Log.i("blablabla", "Response 13 recorded as Positive with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);
			break;
		...
		case R.id.NetRadioButton:
			...
			valuesNeg.put(dbOpenHelper.COLUMN_RESPONSE_THIRTEEN, 1);
			rows=Main.datasource.updateRecord(valuesNeg,(int)Main.rowid);
			Log.i("blablabla", "Response 13 recorded as Negative with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);			
