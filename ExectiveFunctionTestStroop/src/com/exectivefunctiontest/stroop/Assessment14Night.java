...
public class Assessment14Night extends Activity {
	...
	myResponse.setOnCheckedChangeListener(new OnCheckedChangeListener() {
		...
		public void onCheckedChanged(RadioGroup group, int checkedId) {
			...
			case R.id.nightDay:
				...
				values.put(dbOpenHelper.COLUMN_RESPONSE_FOURTEEN, 1);
				int rows=Main.datasource.updateRecord(values,(int)Main.rowid);
				Log.i("blablabla", "Response 14 recorded as Positive with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);
			...
			case R.id.nightNet:
				...
				valuesNeg.put(dbOpenHelper.COLUMN_RESPONSE_FOURTEEN, 0);
				rows=Main.datasource.updateRecord(valuesNeg,(int)Main.rowid);
				Log.i("blablabla", "Response 14 recorded as Negative with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);			
	...
	public void onClick(View v) {
		...
		if(responseID==-1)
		{
			Intent next2=new Intent(Assessment14Night.this,Assessment15Day.class);
	...
	// create a new intent and pass to day 2
		Intent nextScreen=new Intent(Assessment14Night.this,Assessment15Day.class);
