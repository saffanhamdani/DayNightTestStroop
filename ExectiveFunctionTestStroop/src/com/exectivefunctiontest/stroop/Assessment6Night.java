...
public class Assessment6Night extends Activity {
		...
		public void onCheckedChanged(RadioGroup group, int checkedId) {
			...
			/*	Main.consecutiveCorrect++;
				...
				*/
				...
				values.put(dbOpenHelper.COLUMN_RESPONSE_SIX, 1);
				int rows=Main.datasource.updateRecord(values,(int)Main.rowid);
				Log.i("blablabla", "Response 6 recorded as Positive with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);
			...
			case R.id.nightNet:
				...
				valuesNeg.put(dbOpenHelper.COLUMN_RESPONSE_SIX, 0);
				rows=Main.datasource.updateRecord(valuesNeg,(int)Main.rowid);
				Log.i("blablabla", "Response 6 recorded as Negative with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);						
				break;				
...
next.setOnClickListener(new OnClickListener() {
	...
	public void onClick(View v) {
		...
		if(responseID==-1)
		{
			...
			Intent next2=new Intent(Assessment6Night.this,Assessment7Day.class);
		...
		Intent nextScreen=new Intent(Assessment6Night.this,Assessment7Day.class);
