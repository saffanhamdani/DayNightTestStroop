...
public class Assessment15Day extends Activity implements OnCheckedChangeListener{
	...
	next.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if(responseID==-1)
			{
				...
				Intent next2=new Intent(Assessment15Day.this,Assessment16Night.class);
			...
			Intent nextScreen=new Intent(Assessment15Day.this,Assessment16Night.class);
	...
	public void onCheckedChanged(RadioGroup group, int checkedId) {
		...
		case R.id.DayRadioButton:
			...
			valuesNeg.put(dbOpenHelper.COLUMN_RESPONSE_FIFTEEN, 0);
			int rows=Main.datasource.updateRecord(valuesNeg,(int)Main.rowid);
			Log.i("blablabla", "Response 15 recorded as Negative with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);			
			break;
			
		case R.id.NetRadioButton:
			Main.totalCorrect++;
			ContentValues values=new ContentValues();
			values.put(dbOpenHelper.COLUMN_RESPONSE_FIFTEEN, 1);
			rows=Main.datasource.updateRecord(values,(int)Main.rowid);
			Log.i("blablabla", "Response 15 recorded as Positive with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);
			break;
