...
public class Assessment12Night extends Activity {
		...
		public void onCheckedChanged(RadioGroup group, int checkedId) {
			...
			/*	Main.consecutiveCorrect++;
				...
				*/
				...
				values.put(dbOpenHelper.COLUMN_RESPONSE_TWELVE, 1);
				int rows=Main.datasource.updateRecord(values,(int)Main.rowid);
//				Log.i("blablabla", "Response 12 recorded as Positive with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);
			...
			case R.id.nightNet:
				...
				valuesNeg.put(dbOpenHelper.COLUMN_RESPONSE_TWELVE, 0);
				rows=Main.datasource.updateRecord(valuesNeg,(int)Main.rowid);
//				Log.i("blablabla", "Response 12 recorded as Negative with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);			
	...
	// create a new intent and pass to day 2
		...
		if(responseID==-1)
		{
			...
			Intent next2=new Intent(Assessment12Night.this,Assessment13Day.class);
...
//			Log.i("empty", "Response is empty,passing intent");
		...
		Intent nextScreen=new Intent(Assessment12Night.this,Assessment13Day.class);
