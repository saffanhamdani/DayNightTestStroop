...
public class Night3 extends Activity {
	...
	myResponse=(RadioGroup) findViewById(R.id.nightradioGroup);// get reference to radio group
		...
		public void onCheckedChanged(RadioGroup group, int checkedId) {
			...
			case R.id.nightDay:
				...
				Log.i("blablabla", "Response 3 recorded as Positive with Consective Correct Resonses "+Main.consecutiveCorrect);
				break;
				
			case R.id.nightNet:
				Main.consecutiveCorrect=0;
				Log.i("blablabla", "Response 3 recorded as negative with Consective Correct Resonses "+Main.consecutiveCorrect);		
				break;
...
next.setOnClickListener(new OnClickListener() {
	...
	public void onClick(View v) {
		...
		if(responseID==-1)
		{
			Intent next2=new Intent(Night3.this,Day4.class);
		...
		else if(Main.consecutiveCorrect==4)
		{
			...
			Intent startAssesment=new Intent(Night3.this,TrainingEnds.class);
	...
	// create a new intent and pass to day 2
		Intent nextScreen=new Intent(Night3.this,Day4.class);
