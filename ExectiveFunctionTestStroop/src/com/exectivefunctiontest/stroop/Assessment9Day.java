...
public class Assessment9Day extends Activity implements OnCheckedChangeListener{
	...
	next.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if(responseID==-1)
			{
				...
				Intent next2=new Intent(Assessment9Day.this,Assessment10Night.class);
			...
			Intent nextScreen=new Intent(Assessment9Day.this,Assessment10Night.class);
	...
	public void onCheckedChanged(RadioGroup group, int checkedId) {
		...
		case R.id.DayRadioButton:
			...
			valuesNeg.put(dbOpenHelper.COLUMN_RESPONSE_NINE, 0);
			int rows=Main.datasource.updateRecord(valuesNeg,(int)Main.rowid);
			Log.i("blablabla", "Response 9 recorded as Negative with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);			
		...
		case R.id.NetRadioButton:
			...
			values.put(dbOpenHelper.COLUMN_RESPONSE_NINE, 1);
			rows=Main.datasource.updateRecord(values,(int)Main.rowid);
			Log.i("blablabla", "Response 9 recorded as Positive with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);
