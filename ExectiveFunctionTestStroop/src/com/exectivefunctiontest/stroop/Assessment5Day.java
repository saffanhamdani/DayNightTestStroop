...
public class Assessment5Day extends Activity implements OnCheckedChangeListener{
	...
	next.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if(responseID==-1)
			{
				...
				Intent next2=new Intent(Assessment5Day.this,Assessment6Night.class);
			...
			Intent nextScreen=new Intent(Assessment5Day.this,Assessment6Night.class);
	...
	public void onCheckedChanged(RadioGroup group, int checkedId) {
		...
		case R.id.DayRadioButton:
			...
			valuesNeg.put(dbOpenHelper.COLUMN_RESPONSE_FIVE, 0);
			int rows=Main.datasource.updateRecord(valuesNeg,(int)Main.rowid);
			Log.i("blablabla", "Response 5 recorded as Negative with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);			
			break;
			
		case R.id.NetRadioButton:
			Main.totalCorrect++;
			ContentValues values=new ContentValues();
			values.put(dbOpenHelper.COLUMN_RESPONSE_FIVE, 1);
			 rows=Main.datasource.updateRecord(values,(int)Main.rowid);
			Log.i("blablabla", "Response 5 recorded as Positive with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);
