...
public class Assessment4Night extends Activity {
	...
	myResponse.setOnCheckedChangeListener(new OnCheckedChangeListener() {
		...
		public void onCheckedChanged(RadioGroup group, int checkedId) {
			...
			case R.id.nightDay:
				...
				values.put(dbOpenHelper.COLUMN_RESPONSE_FOUR, 1);
				int rows=Main.datasource.updateRecord(values,(int)Main.rowid);
				Log.i("blablabla", "Response 4 recorded as Positive with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);
			...
			case R.id.nightNet:
				...
				valuesNeg.put(dbOpenHelper.COLUMN_RESPONSE_FOUR, 0);
				rows=Main.datasource.updateRecord(valuesNeg,(int)Main.rowid);
				Log.i("blablabla", "Response 4 recorded as Negative with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);			
...
next.setOnClickListener(new OnClickListener() {
	...
	// create a new intent and pass to day 2
		...
		if(responseID==-1)
		{
			Intent next2=new Intent(Assessment4Night.this,Assessment5Day.class);
		...
		Intent nextScreen=new Intent(Assessment4Night.this,Assessment5Day.class);
