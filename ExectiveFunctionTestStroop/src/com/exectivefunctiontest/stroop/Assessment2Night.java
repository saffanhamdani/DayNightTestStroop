...
public class Assessment2Night extends Activity {
		...
		public void onCheckedChanged(RadioGroup group, int checkedId) {
			...
			/*	Main.consecutiveCorrect++;
				...
				*/
				...
				values.put(dbOpenHelper.COLUMN_RESPONSE_TWO, 1);
				int rows=Main.datasource.updateRecord(values,(int)Main.rowid);
				Log.i("blablabla", "Response 2 recorded as Positive with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);
			...
			case R.id.nightNet:
				...
				valuesNeg.put(dbOpenHelper.COLUMN_RESPONSE_TWO, 0);
				rows=Main.datasource.updateRecord(valuesNeg,(int)Main.rowid);
				Log.i("blablabla", "Response 2 recorded as Negative with row id as "+Main.rowid+" NUMBER OF ROWS AFFECTED = "+rows);			
...
next.setOnClickListener(new OnClickListener() {
	...
	public void onClick(View v) {
		...
		if(responseID==-1)
		{
			...
			Intent next2=new Intent(Assessment2Night.this,Assessment3Day.class);
		...
		Intent nextScreen=new Intent(Assessment2Night.this,Assessment3Day.class);
